    ...
    return (
        <SafeAreaView className='flex flex-col justify-between'>
            <View>
                ...
                <Text className='font-bold text-center text-[35px] mt-[90px] text-mainDark'>{heading}</Text>
            ...
            {currentScreen === 3
                ...
                <CustomButton
                    text='Get Started'
                    textStyles='font-bold text-mainWhite text-center text-[22px]'
                    containerStyles='py-5 bg-primary mb-[40px] w-[70%] mx-auto rounded-[20px]'
                    onClick={handleStart}
                />
                :
